<template>
  <list v-if="name === 'list'" :style="style" :className="className" />
  <back v-else-if="name === 'back'" :style="style" :className="className" />
  <next v-else-if="name === 'next'" :style="style" :className="className" />
